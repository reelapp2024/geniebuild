...
export const PRESET_THEMES = [
  {
    ...
    "elements": {
      ...
      "description": "#C7CDD6",
      "surface": "#0E1214",
      "overlay": { "color": "rgba(14, 18, 20, 0.60)", "blend": "multiply" }, 
  ...
  },
  {
    ...
    "elements": {
      ...
      "description": "#BCC6DD",
      "surface": "#0F1222",
      "overlay": { "color": "rgba(15, 18, 34, 0.60)", "blend": "multiply" }, 
  ...
  },
  {
    ...
    "elements": {
      ...
      "description": "#E5E7EB",
      "surface": "#121212",
      "overlay": { "color": "rgba(12,12,12,0.60)", "blend": "multiply" },
  ...
  },
  {
    ...
    "elements": {
      ...
      "description": "#D3DEDA",
      "surface": "#0B1412",
      "overlay": { "color": "rgba(8,12,12,0.60)", "blend": "multiply" },
  ...
  },
  {
    ...
    "elements": {
      ...
      "description": "#D8CCE6",
      "surface": "#120C18",
      "overlay": { "color": "rgba(12, 6, 18, 0.60)", "blend": "multiply" },
  ...
  },
  {
    ...
    "elements": {
      ...
      "description": "#C9D6CF",
      "surface": "#0D1512",
      "overlay": { "color": "rgba(8, 18, 14, 0.60)", "blend": "multiply" },
