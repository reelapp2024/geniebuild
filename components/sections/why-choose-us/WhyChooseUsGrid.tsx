...
export const WhyChooseUsGrid: React.FC<WhyChooseUsProps> = ({ 
  section, 
  isSelected, 
  onTextEdit, 
  onItemEdit, 
  ...
  const getSubtitleElement = (): WebsiteElement => {
    ...
    return {
      id: subtitleId,
      type: 'text',
      content: { text: content.subtitle || 'WHY CHOOSE US', textSize: 'subheading' },
      style: {
  ...
  const getTitleElement = (): WebsiteElement => {
    ...
    let defaultTitle = content.title || 'Excellence in Every Service';
  ...
  const getDescriptionElement = (): WebsiteElement => {
    ...
    return {
      id: descriptionId,
      type: 'text',
      content: { text: content.description || 'We pride ourselves on delivering top-notch solutions tailored to your needs.' },
      style: {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  section={{
                    ...
                    elements: [{
                      ...
                      content: { 
                        ...
                        text: item.title || 'Quality Work',
                        subText: item.description || 'We ensure the highest standards in every project we undertake.',
                      ...
                      style: { 
                        ...
                        titleFontFamily: itemStyle.titleFontFamily,
                        descriptionColor: itemStyle.descriptionColor || itemStyle.textColor || themeColors.textColor,
                        descriptionFontSize: itemStyle.descriptionFontSize || '14px',
                        descriptionFontFamily: itemStyle.descriptionFontFamily,
                        padding: '0'
                      }
                    }]
                  }}
        ...
        {isSelected && (
          ...
          >
            ...
            <span className="font-bold uppercase tracking-widest text-xs" style={{ fontFamily: buttonStyle?.fontFamily }}>Add Benefit</span>
          </button>
        )}
      </div>
    </div>
