...
export const HeroGeometric: React.FC<HeroProps> = ({ 
  ...
  return (
    <div className="relative min-h-[80vh] flex items-center overflow-hidden py-20" style={{ backgroundColor: 'transparent' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-5 hidden lg:block relative">
          <div className="relative w-full aspect-square">
            {/* Main Glass Card */}
            <div className="absolute inset-0 border border-white/10 rounded-3xl transform rotate-3 shadow-2xl flex items-center justify-center overflow-hidden">
