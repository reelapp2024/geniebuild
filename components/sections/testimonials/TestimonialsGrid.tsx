          ...
          return (
            ...
            >
              ...
              <div className="mb-6 relative z-10">
                <ElementsSection 
                  isWrapped={false} 
                  section={{ ...section, elements: [getEl('quote', 'text', { text: item.description || '' }, { fontStyle: 'italic', opacity: '0.8' })] }} 
                  onElementSelect={onElementSelect} 
                  selectedElementId={selectedElementId} 
                  onElementUpdate={onElementUpdate || (() => {})} 
                  onTextEdit={onTextEdit} 
              ...
              <div className="flex items-center gap-4">
                <div className="relative group/avatar">
                  <ElementsSection 
                    isWrapped={false} 
                    section={{ ...section, elements: [getEl('avatar', 'image', { imageUrl: item.avatar || '', alt: item.author || 'Avatar' }, { width: '48px', height: '48px', borderRadius: '50%', objectFit: 'cover' })] }} 
                    onElementSelect={onElementSelect} 
                    selectedElementId={selectedElementId} 
                    onElementUpdate={onElementUpdate || (() => {})} 
                    onTextEdit={onTextEdit} 
