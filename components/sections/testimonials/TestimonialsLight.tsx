...
export const TestimonialsLight: React.FC<TestimonialsLightProps> = ({ 
  section, 
  isSelected, 
  onTextEdit, 
  onItemEdit, 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {isSelected && !readOnly && (
          <button 
            ...
            className="border-2 border-dashed border-gray-300 hover:border-gray-400 hover:bg-gray-50 transition flex flex-col items-center justify-center text-gray-400 font-bold uppercase tracking-widest text-xs gap-2 min-h-[200px] rounded-3xl"
          >
